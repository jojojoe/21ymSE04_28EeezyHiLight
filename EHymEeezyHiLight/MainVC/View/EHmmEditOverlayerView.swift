...
class EHmmEditOverlayerView: UIView {
...
extension EHmmEditOverlayerView {
    func loadData() {
        
        list = EHmmDataManager.default.overlayerList
...
extension EHmmEditOverlayerView: UICollectionViewDataSource {
...
extension EHmmEditOverlayerView: UICollectionViewDelegateFlowLayout {
...
extension EHmmEditOverlayerView: UICollectionViewDelegate {
